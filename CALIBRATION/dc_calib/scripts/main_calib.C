...
int main_calib()
{
  ...
  DC_calib obj("SHMS", "../../../ROOTfiles/shms_replay_production_all_add_151118.root", 151118, -1, "pid_kFALSE", "card");                                                                                                       
  // DC_calib obj("HMS", "../../../ROOTfiles/hms_replay_production_all_1606_uncal.root",1606, -1, "pid_kFALSE","card");
